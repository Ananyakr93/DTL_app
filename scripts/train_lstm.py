...
# Filter for Bangalore (Training usually specific to a location or use all?)
# Given we are forecasting, mixing locations without explicit Feature is bad.
# Let's filter for Bangalore to be consistent with GRU
...
feature_columns = [
    ...
    'so2', 'no2',  # Full pollutant features (CPCB standard)
...
LOOKBACK = 72  # Extended from 48 to 72 hours for weekly patterns
